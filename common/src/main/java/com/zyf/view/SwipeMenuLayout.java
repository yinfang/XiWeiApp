 ...
 * Item侧滑删除菜单
 * 使用示例：
 * 1.xml布局 用SwipeMenuLayout包裹item，item元素依次放置
 * <com.zyf.view.SwipeMenuLayout
 * xmlns:android="http://schemas.android.com/apk/res/android"
 * android:layout_width="match_parent"
 * android:layout_height="100dp"
 * android:clickable="true"
 * app:leftSwipe="true"  //是否支持左滑右滑
 * app:swipeEnable="true"  //根据角色，是否开启侧滑菜单
 ...
 * 2.列表adapter中设置按钮onclick，item点击事件需对Content单独设置点击事件
 * //这句话关掉IOS阻塞式交互效果 并依次打开左滑右滑  禁用掉侧滑菜单
 * ((SwipeMenuLayout) holder.itemView).setIos(false).setLefleftSwipetSwipe(position % 2 == 0 ? true : false).setSwipeEnable(false);
 */
