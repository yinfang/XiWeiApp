...
import com.kunbo.xiwei.activity.monitor.OverHighInActivity;
...
public class OverHighInPhotoAdapter extends RecyclerCommonAdapter {
    private OverHighInActivity context;

    public OverHighInPhotoAdapter(OverHighInActivity context, int layoutId, List datas) {
