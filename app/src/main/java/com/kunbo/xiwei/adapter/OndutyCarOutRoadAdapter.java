...
public class OndutyCarOutRoadAdapter extends RecyclerCommonAdapter {
    private ClassOndutyActivity context;
    boolean isCarIn = false;

    public OndutyCarOutRoadAdapter(ClassOndutyActivity context, List datas) {
    ...
    protected void convert(ViewHolder holder, Object o, int position) {
        ...
        addLl.setOnClickListener(v -> context.addCarOutLl());
        removeLl.setOnClickListener(v -> context.removeCarOutLl(position));
    }
